...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      initEcharts() {
        var _this = this;
        this.$http.get('/holecoverServer/evolutionStatistics?city=' + "济南市" + '&startTime='+ this.timeso +'&endTime='+ this.timest +'')
          .then(res => {
      ...
      Deductions() {
        ...
        this.pro = '济南市';
        this.$http.get('/holecoverServer/evolution?sortListType=true&sortListColumn=insertTime&city=' + _this.pro + '&startTime=' + fromTime + '&endTime=' + toTime)
          .then(res => {
            _this.data = [];
